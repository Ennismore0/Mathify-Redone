...
cls
echo Welcome to Mathify Redone v1.1^^!
timeout /t 1 >nul
echo -------------------------------------
timeout /t 1 >nul
echo This is a remake of my old project, "Mathify"!
timeout /t 2 >nul
echo Just so you know, Mathify Redone v1.1 is meant for simple equations, so no large-scale operations^^!
timeout /t 2 >nul
